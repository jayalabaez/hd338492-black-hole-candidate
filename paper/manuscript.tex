...
\author[J. Ayala-Baez]{
  Jayson Ayala-Baez$^{1}$\thanks{E-mail: jayalabaez@gmail.com}\\
...
black hole.  We systematically exclude five of six alternative
scenarios (main-sequence companion, white dwarf, neutron star,
hierarchical triple, astrometric artefact) and disfavour a sixth
(stripped helium star) on energetic grounds.  We conclude that
HD~338492 is among the most compelling dormant stellar-mass black
hole candidates from Gaia DR3, rivalling Gaia~BH1, BH2, and BH3 in
the strength of its dynamical evidence, and recommend immediate
ground-based radial-velocity follow-up ($\sim$8--10 epochs over two
months) to confirm the orbit.
\end{abstract}
...
$A_\lambda / A_V$ from \citet{Cardelli1989}.  The dereddened SED
...
\medskip\noindent
\textbf{Summary:} Five of six alternative scenarios are excluded.
The remaining scenario (stripped He star) is disfavoured on
energetic and statistical grounds.  A black hole is overwhelmingly
...
($M_2 \approx 33\,\Msun$; \citealt{GaiaBH3_2024}).  While those
systems were confirmed with independent RV campaigns, HD~338492 is
presented here at the candidate stage --- its mass function alone
exceeds the Chandrasekhar limit, providing a level of dynamical
evidence comparable to the confirmed systems \emph{prior to their
...
\item Five of six alternative non-BH scenarios are excluded; the
  sixth (stripped He star) is disfavoured on energetic grounds.
...
stellar-mass black hole candidate} and recommend immediate
ground-based radial-velocity follow-up to confirm the orbit and
establish it as a bona fide black hole.
...
The analysis scripts and compiled data products are available at
...
indicates OPEN (inconclusive).  The system scores 11P/2O/0F ---
a ``compelling'' BH candidate.}
\label{fig:checklist}
\end{figure}
